...
public class HasOneItemByCriteriaAssertion<TCollection, TItem>(
    ...
    where TCollection : IEnumerable<TItem>
{
            ...
            { Value: { } collection } => collection.ToList() switch
            {
                ...
                var list =>
                    await this.ApplyCriteriaAsync(list) switch
                    {
                        ...
                        (1, _) => AssertionResult.Passed,
                        (var matchCount, _) => AssertionResult.Failed($"{matchCount} {itemDescription}s were found"),
                    },
            },
    ...
    protected override string GetExpectation() =>
        this.expectation is not null
            ? $"exactly one {itemDescription} with {this.expectation}"
