...
namespace Allure.TestingPlatform.Tests.SdkExtensibility.CustomRegistrationContext;

public class CustomRegistrationContextTests
{
    [Test]
    public async Task ShouldRegisterBrandedContextAndCustomRuntime()
    {
    ...
    sealed class MyFrameworkCorrelationContext : ICorrelationContext
    {
        public CorrelationUid CurrentCorrelationUid { get; } =
            new("custom-registration-context");
    }
