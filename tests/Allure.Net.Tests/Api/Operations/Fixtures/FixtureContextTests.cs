...
public class FixtureContextTests
{
    ...
    {
        var context = CreateSyncFixtureContext();
    ...
    public async Task SetNameAsyncWithoutTokenForwardsDefaultTokenAndTask()
    {
        ...
        var context = IAllureAsyncFixtureContext.Mock();
    ...
    {
        TaskCompletionSource tcs = new();
        var context = CreateAsyncFixtureContext(tcs.Task);
    ...
    private static IAllureAsyncFixtureContextMock CreateAsyncFixtureContext(Task resultTask)
    {
        var context = IAllureAsyncFixtureContext.Mock();
        context.ParameterSerializer.Returns(new TestParameterSerializer());
