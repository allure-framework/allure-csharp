    ...
    IDisposable
{
    ...
    readonly IDisposable scope = runtime.ExecutionStateContext.EnterApiFixtureScope(fixtureUid);
    ...
    {
        AllureFixtureUpdateMessage message = new(runtime.CorrelationContext.CurrentCorrelationUid, fixtureUid)
        {
