...
public static partial class AllureApi
{
    ...
    public static void AddGlobalAttachment(string path) =>
        AllureFrontend.Client.ResolveCurrentScope()?.Operations.Sync.AddGlobalFileAttachment(
    ...
    {
        AllureFrontend.Client.ResolveCurrentScope()?.Operations.Sync.AddGlobalAttachment(
            name: name,
            content: content,
            mediaType: null,
            fileExtension: ""
    ...
    public static void AddGlobalError(Exception error) =>
        AllureFrontend.Client.ResolveCurrentScope()?.Operations.Sync.AddGlobalError(
