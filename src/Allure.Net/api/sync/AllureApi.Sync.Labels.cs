...
public static partial class AllureApi
{
    ...
    public static void AddLabels(params IEnumerable<Label> labels) =>
        AllureFrontend.Client.Operations.Sync.AddLabels(labels);
    ...
    public static void AddLabel(string name, string value) =>
        AllureFrontend.Client.Operations.Sync.AddLabel(
    ...
    public static void AddLabel(Label label) =>
        AllureFrontend.Client.Operations.Sync.AddLabel(label);
    ...
    public static void SetSeverity(Severity severity) =>
        AllureFrontend.Client.Operations.Sync.SetLabel(
            LabelName.Severity,
    ...
    public static void AddTags(params string[] tags) =>
        AllureFrontend.Client.Operations.Sync.AddLabels(
