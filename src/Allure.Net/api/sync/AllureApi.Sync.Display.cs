...
public static partial class AllureApi
{
    ...
    public static void SetTestName(string newName) =>
        AllureFrontend.Client.Operations.Sync.SetTestName(newName);
    ...
    public static void SetFixtureName(string newName) =>
        AllureFrontend.Client.Operations.Sync.SetFixtureName(newName);
    ...
    public static void SetName(string newName) =>
        AllureFrontend.Client.Operations.Sync.SetName(newName);
    ...
    public static void SetDescription(string description) =>
        AllureFrontend.Client.Operations.Sync.SetDescription(description);
    ...
    public static void SetDescriptionHtml(string descriptionHtml) =>
        AllureFrontend.Client.Operations.Sync.SetDescriptionHtml(descriptionHtml);
}
