...
public static partial class AllureApi
{
    ...
    public static Task AddGlobalFileAttachmentAsync(string path) =>
        AllureFrontend.Runtime.TestApi.Async.AddGlobalFileAttachment(
    ...
    public static Task AddGlobalAttachmentAsync(string name, Stream content) =>
        AllureFrontend.Runtime.TestApi.Async.AddGlobalAttachment(
            name: name,
            content: content,
            mediaType: null,
            fileExtension: "",
    ...
    )
    {
        ...
        return AllureFrontend.Runtime.TestApi.Async.AddGlobalAttachment(
            name: name,
            content: stream,
            mediaType: null,
            fileExtension: "",
    ...
    public static Task AddGlobalErrorAsync(Exception error) =>
        AllureFrontend.Runtime.TestApi.Async.AddGlobalError(
