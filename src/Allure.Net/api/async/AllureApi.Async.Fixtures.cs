...
public static partial class AllureApi
{
    public static Task SetUp(string name, Func<Task> body) =>
        AllureFrontend.Client.Operations.Async.SetUpAsync(name, [], body, default);

    public static Task SetUp(string name, Func<Task> body, CancellationToken cancellationToken) =>
        AllureFrontend.Client.Operations.Async.SetUpAsync(name, [], body, cancellationToken);
    ...
    public static Task TearDown(string name, Func<Task> body) =>
        AllureFrontend.Client.Operations.Async.TearDownAsync(name, [], body, default);
    ...
    public static Task TearDown(
        ...
        AllureFrontend.Client.Operations.Async.TearDownAsync(name, [], body, cancellationToken);
