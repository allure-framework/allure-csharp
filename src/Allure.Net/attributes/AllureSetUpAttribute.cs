...
public sealed class AllureSetUpAttribute : AllureOperationAttribute
{
    ...
    /// arguments.
    /// </param>
    public AllureSetUpAttribute(string name) : base(name) { }
}
