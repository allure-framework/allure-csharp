...
class AllureSetUpRouter : AllureOperationRouter
{
    protected override void Run(
        ...
        AllureFrontend.Client.Operations.Sync.SetUp(name, parameters, body);
    ...
    protected override Task RunAsync(
        ...
        AllureFrontend.Client.Operations.Async.SetUpAsync(name, parameters, body, cancellationToken);
